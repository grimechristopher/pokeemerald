...
#define OW_GFX_COMPRESS                FALSE      // Adds support for compressed OW graphics, (Also compresses Pokémon follower graphics). Left off while WE_OW_ENCOUNTERS is on - see its comment in config/wild_encounter.h (VRAM issues otherwise).
